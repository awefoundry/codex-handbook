...
- 采用标题：`Codex 权限怎么设才安全？一份可复用的日常检查清单`。
- 输出：`D:/codexguide_all/教程/10-配置模型与权限安全/07-Codex权限怎么设才安全-一份可复用的日常检查清单-封面.png`。
- 生成任务：`task_gptimage_1787801531823_54f76795`；尺寸 1672×941；已目检标题文字、主体构图和敏感信息。
