...
![PowerShell 中检查 Codex 版本和命令路径](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/01-排障证据.png)
...
![Microsoft Store 初始化失败](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/02-排障证据.png)
...
![Codex CLI 登录状态](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/03-排障证据.png)
...
![Codex CLI 已启动但模型仍在加载](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/04-排障证据.png)
...
![VS Code 扩展市场中的官方 Codex](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/05-排障证据.png)
...
![VS Code 中的 Codex 登录入口](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/06-排障证据.png)
...
![VS Code 中 Codex 面板空白](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/07-排障证据.png)

图七  Codex 面板没有加载出登录入口，只显示空白区域和加载图标。来源为 [OpenAI Codex Issue #28280](https://github.com/openai/codex/issues/28280)。

![VS Code 提示窗口没有响应](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/08-排障证据.png)
...
![VS Code 中 Codex 登录成功](../图片素材/01-安装与首次使用/13-安装登录常见问题-发布/09-排障证据.png)
