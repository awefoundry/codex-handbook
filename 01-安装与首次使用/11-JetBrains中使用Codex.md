...
![JetBrains 官方品牌图](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/01-JetBrains官方品牌图.png)
<p align="center">图一 JetBrains 官方品牌图，来源于 <a href="https://www.jetbrains.com/company/brand/">JetBrains Brand Guidelines</a></p>

![Codex 官方图标](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/02-Codex官方图标.png)
...
![JetBrains 的 Settings 入口](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/03-JetBrains设置入口.png)
...
![首次打开 JetBrains AI 的引导界面](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/04-JetBrains-AI首次引导.png)
...
![在 Plugins 中搜索 JetBrains AI Assistant](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/05-搜索AI-Assistant插件.png)
<p align="center">图五 在 Plugins 页面搜索 JetBrains AI Assistant</p>

![JetBrains AI Assistant 插件详情](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/06-AI-Assistant插件详情.png)
...
![AI Chat 的 Agent 选择器](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/07-Agent选择器.png)
...
![Codex 的登录方式](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/08-Codex认证方式.png)
...
![JetBrains 账号登录页面](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/09-JetBrains账号登录.png)
...
![Codex 限时免费提示](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/10-Codex限时活动提示.png)
...
![Codex 的模型和推理强度选择](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/11-Codex模型与推理强度.png)
...
![Codex 执行任务的进度展示](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/12-Codex任务进度.png)
...
![AI Chat 展示修改清单](../图片素材/01-安装与首次使用/11-JetBrains中使用Codex/13-AI-Chat修改清单.png)
