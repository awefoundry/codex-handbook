...
> 配图采集环境：macOS 15.7.5（Build 24G624）；Codex/ChatGPT App 26.721.41059；2026-08-21 核验。
...
![最小充分上下文](./04-给Codex多大上下文才够用-未发布-图片备份-20260819-1142/manual/04-03-最小充分上下文.png)

*图：面向公开示例代码的独立任务输入，包含目标、文件路径、已有证据和验收方式；停在实际修改之前。*

![三组结果对照](./04-给Codex多大上下文才够用-未发布-图片备份-20260819-1142/manual/04-04-三组结果对照.png)

*图：信息不足、过量和最小充分三组记录的调查范围、追问次数与结论差异对照。*
