...
- `01-openai-agent-approvals-security.png`：适用于“先把三个概念分开”，同一视口展示 Sandbox mode 与 Approval policy 的官方两层定义；来源：[Agent approvals & security](https://developers.openai.com/codex/agent-approvals-security)，OpenAI，持续更新文档，2026-08-21 直接打开核验。时效提示：文档导航和措辞可能更新。
- `02-openai-permissions-menu.png`：适用于“常见动作分别需要什么能力”，展示 Codex Desktop 权限菜单和“选择最窄审批范围”的官方说明；来源：[Sandbox](https://developers.openai.com/codex/concepts/sandboxing)，OpenAI，持续更新文档，2026-08-21 直接打开核验。时效提示：菜单名称和选项可能随版本变化。
- `03-youtube-declined-approval-result.png`：适用于“哪些情况应该收紧或拒绝”，显示拒绝审批后命令取消、报告未生成；来源：[Codex Permissions Explained: Sandbox vs Approval Policy](https://www.youtube.com/watch?v=zXTa_7Tc2EY)，Coding With Chuck，YouTube，2026-08-17，`00:03:31`。第三方当前界面，建议本机复现后替换。
- `04-youtube-approved-command-scope.png`：适用于“哪些情况可以放行”，显示审阅已知脚本后按明确范围批准命令；同一视频，`00:07:42`。第三方当前界面，建议本机复现后替换。

### AI 生成油画风格教学示意

- `05-ai-permission-sandbox-approval-layers.png`：适用于“先把三个概念分开”，用外层网络边界、工作区沙箱和内层人工审批闸门解释三层关系。该图由 AI 生成并采用油画风格，不是 Codex 产品截图，也不能证明当前 UI 或实际运行结果；生成日期：2026-08-21。
